                ...
                <div className='container mx-auto shadow-xl my-10 p-10 rounded-xl'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <input type="text" className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' 
                            placeholder={userOldData.name} onChange={(e) => setNewName(e.target.value)} value={newName} />
                        <input type="email" className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' 
                            placeholder={userOldData.email} onChange={(e) => setNewEmail(e.target.value)} value={newEmail} />
                        <input type="password" className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' 
                            placeholder={userOldData.password} onChange={(e) => setNewPassword(e.target.value)} value={newPassword} />
